<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpStock.aspx.vb" Inherits="AdmEconomato.PopUpStock"%>
				...
				<thead>
					<tr>
						<td style="WIDTH: 528px; HEIGHT: 52px" colSpan="4">
							<P><STRONG><STRONG><asp:label id="lblTitulo" runat="server" Width="504px" BackColor="#E0E0E0"> Seleccionar Artículo del Stock</asp:label></STRONG></STRONG></P>
						</td>
					</tr>
				</thead>
				<tbody>
					...
					<TD colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="512px" Height="0px" AllowPaging="True" PageSize="10"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Descripcion" Visible="true">
									<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									<ItemTemplate>
										<asp:label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "dsElemento")  %>' ID="lblElemento1" />
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn HeaderText="Stock" Visible="true">
									<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									<ItemTemplate>
										<asp:label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Disponible")  %>' ID="Label3" />
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
