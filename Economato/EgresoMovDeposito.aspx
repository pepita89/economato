...
<HTML>
	<HEAD>
		<title>Movimientos entre Depósitos</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<BR>
			<p>&nbsp;
				<asp:label id="lblTitulo" runat="server" Width="600px" CssClass="tituloNota" Height="16px"> Movimientos entre Depósitos</asp:label></p>
			<BR>
			<table style="WIDTH: 624px; HEIGHT: 0px" height="0">
				...
				<tbody>
					...
					<tr>
						<td style="WIDTH: 205px; HEIGHT: 26px" width="205">&nbsp;Depósito Destino</td>
					...
					<tr>
						...
						<td style="WIDTH: 310px; HEIGHT: 26px">&nbsp;<asp:dropdownlist id="Dropdownlist1" runat="server" Width="300px">
								<asp:ListItem Value="1">Préstamo</asp:ListItem>
