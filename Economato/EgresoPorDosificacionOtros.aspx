	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<p><asp:label id="lblTitulo" style="Z-INDEX: 105; LEFT: 8px; POSITION: relative; TOP: 0px" runat="server"
					Width="600px" Height="16px" CssClass="tituloNota"> Entrega de Mercadería por dosificación de Otros Pedidos</asp:label></p>
			<p><asp:label id="Label3" style="Z-INDEX: 106; LEFT: 8px; POSITION: relative; TOP: 0px" runat="server"
					Width="440px" CssClass="subTituloNota">Ingrese Número de dosificación a entregar</asp:label><asp:textbox id="Textbox2" style="Z-INDEX: 107; LEFT: 40px; POSITION: relative; TOP: 0px" runat="server"
			...
			<p>
				<table style="Z-INDEX: 101; LEFT: 8px; WIDTH: 608px; POSITION: relative; TOP: 0px; HEIGHT: 152px"
					...
					<tbody>
						<tr>
							<td style="WIDTH: 225px; HEIGHT: 2px" width="225">&nbsp;Fecha Dosificación</td>
				...
				<TR>
					<TD><STRONG>Agregar otro Elemento</STRONG>&nbsp;
						<TABLE style="WIDTH: 600px; HEIGHT: 0px">
							<TBODY>
								<TR>
									<TD style="WIDTH: 68px; HEIGHT: 15px">Artículo
									</TD>
