<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EgresoPorPedidoCocina.aspx.vb" Inherits="AdmEconomato.EgresoPorPedidoCocina"%>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<BR>
			<p>&nbsp;
				<asp:label id="lblTitulo" runat="server" Height="0px" CssClass="tituloNota" Width="600px"> Egreso por Pedido de Cocina</asp:label></p>
			<BR>
			<table style="WIDTH: 624px; HEIGHT: 0px" height="226" width="600">
				...
				<tbody>
					...
					<tr>
						<td width="262" style="HEIGHT: 13px">&nbsp;Sector de Cocina</td>
						<td style="HEIGHT: 13px">&nbsp;
							<asp:dropdownlist id="CboResponsables" runat="server" Width="340px">
								<asp:ListItem Value="43">Reposter&#237;a Presidencial</asp:ListItem>
								<asp:ListItem Value="44">Cocina Presidencial</asp:ListItem>
							</asp:dropdownlist></td>
						<td align="center" width="20" style="HEIGHT: 13px">*</td>
					</tr>
					<tr>
						<td width="262" height="20">
							&nbsp;Responsable del Retiro</td>
					...
					<td><STRONG>Agregar Artículo</STRONG>
						<table style="WIDTH: 616px; HEIGHT: 0px">
							<tr>
								...
								<td colspan="3">&nbsp;
									<asp:textbox id="Textbox5" runat="server" Width="396px">Lata de Palmitos x 1 kg</asp:textbox>
							...
							<tr>
								...
								<td colspan="3">&nbsp;<asp:label id="Label3" runat="server" Width="104px">Lata</asp:label></td>
							</tr>
							<TR>
